...
- **20 种动效卡**:章节进度条、双语字幕层、要点钉板、数字/圆环/计数器、双栏对比、金句定格、步骤时间线、术语卡、界面标注、文字进场、人物名牌、运镜与终端演示 —— 覆盖全部 11 个用途分组,足够完整做出一期视频
...
- **20 张动效卡**,覆盖 11 个用途分组:常驻层、证据、数据、对比、金句、步骤、
  教程标注、文字进场、人物锚定、运镜、B-roll
